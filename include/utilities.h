...
void applyGaussianBlur(const myMat<uchar> &inImg, myMat<uchar> &outImg, const uint kernel_size);

void sumOverKernel(myMat<float> &inImg, myMat<float> &outImg, const uint kernel_size);
